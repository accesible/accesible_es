...
id: accesibilidad
title: Accesibilidad
# sidebar_label: Accesibilidad y más
---

La accesibilidad es el grado o nivel en el que las personas pueden utilizar un objeto, acceder a un lugar o servicio, con independencia de sus capacidades técnicas, cognitivas o físicas.
...
- Utilizar sólo el teclado para moverte por toda la web (Teclas ←↑↓→ TAB, SHIFT+TAB, ESC y ENTER .)
...
Bajo las WCAG 2.1, Existen 3 niveles para **medir la accesibilidad de un sitio**.
...
- 1.4.2 Control de audio: No reproducir el audio automáticamente.
...
- 2.2.2 Pausa, Parar, Ocultar: Proporcionar controles de usuario para mover el contenido.
...
- 1.2.6 Lenguaje de señas (pregrabado): proporcione traducciones en lenguaje de señas para videos.
...
- 1.2.9 Solo audio (en vivo): brinde alternativas para audio en vivo.
...
- 2.2.5 Reautenticación: guarde los datos del usuario al volver a autenticarse.
